...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    wasmTable = wasmExports["gi"];
    addOnInit(wasmExports["bi"]);
...
var wasmImports = {
  ai: _JS_TextInput_clearFocus,
  $h: _JS_TextInput_create,
  _h: _JS_TextInput_focus,
  Zh: _JS_TextInput_getText,
  Yh: _JS_TextInput_initialize,
  Xh: _JS_TextInput_remove,
  Wh: _JS_TextInput_setAutoCapitalize,
  Vh: _JS_TextInput_setHint,
  Uh: _JS_TextInput_setHintTextColor,
  Th: _JS_TextInput_setKeyboardType,
  Sh: _JS_TextInput_setMaxLength,
  Rh: _JS_TextInput_setPosition,
  Qh: _JS_TextInput_setReturnKeyType,
  Ph: _JS_TextInput_setSize,
  Oh: _JS_TextInput_setText,
  Nh: _JS_TextInput_setTextColor,
  Mh: _JS_TextInput_setTextSize,
  Lh: _JS_TextInput_setVisible,
  b: ___assert_fail,
...
var _wasm_call_ctors = function ___wasm_call_ctors() {
  return (_wasm_call_ctors = wasmExports["bi"])();
};
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function () {
  return (_dmExportedSymbols = Module["_dmExportedSymbols"] = wasmExports["ci"])();
};
var _main = Module["_main"] = function (a0, a1) {
  return (_main = Module["_main"] = wasmExports["di"])(a0, a1);
};
var _malloc = Module["_malloc"] = function (a0) {
  return (_malloc = Module["_malloc"] = wasmExports["ei"])(a0);
};
var _free = Module["_free"] = function (a0) {
  return (_free = Module["_free"] = wasmExports["fi"])(a0);
};
