...
var WebView = {
  ...
  addEventToQueue: function addEventToQueue(id, name, value) {
    if (WebView.list[id]) {
      ...
      var cstr = stringToNewUTF8(value);
      getWasmTableEntry(AddToCommandQueue)(id, name, cstr, data.requestId);
      _free(cstr);
    }
  }
};
function _JS_WebView_continueOpen(id, url, requestId) {
  if (WebView.list[id]) {
    var data = WebView.list[id];
...
function _JS_WebView_create(id) {
...
function _JS_WebView_destroy(id) {
  if (WebView.list[id]) {
    var data = WebView.list[id];
...
function _JS_WebView_eval(id, code, requestId) {
  if (WebView.list[id]) {
    var data = WebView.list[id];
    data.requestId = requestId;
  }
}
function _JS_WebView_finalize() {
...
function _JS_WebView_initialize(c_AddToCommandQueue) {
  WebView._AddToCommandQueue = c_AddToCommandQueue;
}
function _JS_WebView_isVisible(id) {
  return data.iframe.style.display == "none" ? 1 : 0;
}
function _JS_WebView_open(id, url, requestId) {
  if (WebView.list[id]) {
    var data = WebView.list[id];
    data.requestId = requestId;
    data.iframe.src = UTF8ToString(url);
...
function _JS_WebView_openRaw(id, html, requestId) {
  if (WebView.list[id]) {
    var data = WebView.list[id];
    data.requestId = requestId;
...
function _JS_WebView_setPosition(id, x, y, width, height) {
  if (WebView.list[id]) {
    var data = WebView.list[id];
...
function _JS_WebView_setVisible(id, visible) {
  if (WebView.list[id]) {
    var data = WebView.list[id];
...
function _ShareFile(data, type, name, title, text, url) {
  if (navigator && navigator.share) {
    try {
      ...
      navigator.share(shareData).then().catch(function (err) {
...
var wasmImports = {
  ...
  nh: _emscripten_glActiveTexture,
  mh: _emscripten_glAttachShader,
  lh: _emscripten_glBeginQuery,
  kh: _emscripten_glBeginQueryEXT,
  jh: _emscripten_glBeginTransformFeedback,
  ih: _emscripten_glBindAttribLocation,
  hh: _emscripten_glBindBuffer,
  gh: _emscripten_glBindBufferBase,
  fh: _emscripten_glBindBufferRange,
  eh: _emscripten_glBindFramebuffer,
  dh: _emscripten_glBindRenderbuffer,
  ch: _emscripten_glBindSampler,
  bh: _emscripten_glBindTexture,
  ah: _emscripten_glBindTransformFeedback,
  $g: _emscripten_glBindVertexArray,
  _g: _emscripten_glBindVertexArrayOES,
  Zg: _emscripten_glBlendColor,
  Yg: _emscripten_glBlendEquation,
  Xg: _emscripten_glBlendEquationSeparate,
  Wg: _emscripten_glBlendFunc,
  Vg: _emscripten_glBlendFuncSeparate,
  Ug: _emscripten_glBlitFramebuffer,
  Tg: _emscripten_glBufferData,
  Sg: _emscripten_glBufferSubData,
  Rg: _emscripten_glCheckFramebufferStatus,
  Qg: _emscripten_glClear,
  Pg: _emscripten_glClearBufferfi,
  Og: _emscripten_glClearBufferfv,
  Ng: _emscripten_glClearBufferiv,
  Mg: _emscripten_glClearBufferuiv,
  Lg: _emscripten_glClearColor,
  Kg: _emscripten_glClearDepthf,
  Jg: _emscripten_glClearStencil,
  Ig: _emscripten_glClientWaitSync,
  Hg: _emscripten_glColorMask,
  Gg: _emscripten_glCompileShader,
  Fg: _emscripten_glCompressedTexImage2D,
  Eg: _emscripten_glCompressedTexImage3D,
  Dg: _emscripten_glCompressedTexSubImage2D,
  Cg: _emscripten_glCompressedTexSubImage3D,
  Bg: _emscripten_glCopyBufferSubData,
  Ag: _emscripten_glCopyTexImage2D,
  zg: _emscripten_glCopyTexSubImage2D,
  yg: _emscripten_glCopyTexSubImage3D,
  ...
  rg: _emscripten_glDeleteQueries,
  qg: _emscripten_glDeleteQueriesEXT,
  pg: _emscripten_glDeleteRenderbuffers,
  og: _emscripten_glDeleteSamplers,
  ng: _emscripten_glDeleteShader,
  mg: _emscripten_glDeleteSync,
  lg: _emscripten_glDeleteTextures,
  kg: _emscripten_glDeleteTransformFeedbacks,
  jg: _emscripten_glDeleteVertexArrays,
  ig: _emscripten_glDeleteVertexArraysOES,
  hg: _emscripten_glDepthFunc,
  gg: _emscripten_glDepthMask,
  fg: _emscripten_glDepthRangef,
  eg: _emscripten_glDetachShader,
  dg: _emscripten_glDisable,
  cg: _emscripten_glDisableVertexAttribArray,
  bg: _emscripten_glDrawArrays,
  ag: _emscripten_glDrawArraysInstanced,
  $f: _emscripten_glDrawArraysInstancedANGLE,
  _f: _emscripten_glDrawArraysInstancedARB,
  Zf: _emscripten_glDrawArraysInstancedEXT,
  Yf: _emscripten_glDrawArraysInstancedNV,
  Xf: _emscripten_glDrawBuffers,
  Wf: _emscripten_glDrawBuffersEXT,
  Vf: _emscripten_glDrawBuffersWEBGL,
  Uf: _emscripten_glDrawElements,
  Tf: _emscripten_glDrawElementsInstanced,
  Sf: _emscripten_glDrawElementsInstancedANGLE,
  Rf: _emscripten_glDrawElementsInstancedARB,
  Qf: _emscripten_glDrawElementsInstancedEXT,
  ...
  Kf: _emscripten_glEndQueryEXT,
  Jf: _emscripten_glEndTransformFeedback,
  If: _emscripten_glFenceSync,
  ...
  Df: _emscripten_glFramebufferTextureLayer,
  Cf: _emscripten_glFrontFace,
  Bf: _emscripten_glGenBuffers,
  Af: _emscripten_glGenFramebuffers,
  zf: _emscripten_glGenQueries,
  yf: _emscripten_glGenQueriesEXT,
  xf: _emscripten_glGenRenderbuffers,
  wf: _emscripten_glGenSamplers,
  vf: _emscripten_glGenTextures,
  uf: _emscripten_glGenTransformFeedbacks,
  tf: _emscripten_glGenVertexArrays,
  sf: _emscripten_glGenVertexArraysOES,
  rf: _emscripten_glGenerateMipmap,
  qf: _emscripten_glGetActiveAttrib,
  pf: _emscripten_glGetActiveUniform,
  of: _emscripten_glGetActiveUniformBlockName,
  nf: _emscripten_glGetActiveUniformBlockiv,
  mf: _emscripten_glGetActiveUniformsiv,
  lf: _emscripten_glGetAttachedShaders,
  kf: _emscripten_glGetAttribLocation,
  jf: _emscripten_glGetBooleanv,
  hf: _emscripten_glGetBufferParameteri64v,
  gf: _emscripten_glGetBufferParameteriv,
  ff: _emscripten_glGetError,
  ef: _emscripten_glGetFloatv,
  df: _emscripten_glGetFragDataLocation,
  cf: _emscripten_glGetFramebufferAttachmentParameteriv,
  bf: _emscripten_glGetInteger64i_v,
  af: _emscripten_glGetInteger64v,
  $e: _emscripten_glGetIntegeri_v,
  _e: _emscripten_glGetIntegerv,
  Ze: _emscripten_glGetInternalformativ,
  Ye: _emscripten_glGetProgramBinary,
  Xe: _emscripten_glGetProgramInfoLog,
  We: _emscripten_glGetProgramiv,
  Ve: _emscripten_glGetQueryObjecti64vEXT,
  Ue: _emscripten_glGetQueryObjectivEXT,
  Te: _emscripten_glGetQueryObjectui64vEXT,
  Se: _emscripten_glGetQueryObjectuiv,
  Re: _emscripten_glGetQueryObjectuivEXT,
  Qe: _emscripten_glGetQueryiv,
  Pe: _emscripten_glGetQueryivEXT,
  Oe: _emscripten_glGetRenderbufferParameteriv,
  Ne: _emscripten_glGetSamplerParameterfv,
  Me: _emscripten_glGetSamplerParameteriv,
  ...
  Ge: _emscripten_glGetStringi,
  Fe: _emscripten_glGetSynciv,
  Ee: _emscripten_glGetTexParameterfv,
  De: _emscripten_glGetTexParameteriv,
  Ce: _emscripten_glGetTransformFeedbackVarying,
  Be: _emscripten_glGetUniformBlockIndex,
  Ae: _emscripten_glGetUniformIndices,
  ze: _emscripten_glGetUniformLocation,
  ye: _emscripten_glGetUniformfv,
  xe: _emscripten_glGetUniformiv,
  we: _emscripten_glGetUniformuiv,
  ve: _emscripten_glGetVertexAttribIiv,
  ue: _emscripten_glGetVertexAttribIuiv,
  ...
  pe: _emscripten_glInvalidateFramebuffer,
  oe: _emscripten_glInvalidateSubFramebuffer,
  ...
  he: _emscripten_glIsRenderbuffer,
  ge: _emscripten_glIsSampler,
  fe: _emscripten_glIsShader,
  ee: _emscripten_glIsSync,
  de: _emscripten_glIsTexture,
  ce: _emscripten_glIsTransformFeedback,
  be: _emscripten_glIsVertexArray,
  ae: _emscripten_glIsVertexArrayOES,
  $d: _emscripten_glLineWidth,
  _d: _emscripten_glLinkProgram,
  Zd: _emscripten_glPauseTransformFeedback,
  Yd: _emscripten_glPixelStorei,
  ...
  hc: _emscripten_websocket_delete,
  gc: _emscripten_websocket_new,
  fc: _emscripten_websocket_send_binary,
  ec: _emscripten_websocket_send_utf8_text,
  dc: _emscripten_websocket_set_onclose_callback_on_thread,
